...
gkSteeringFlee::gkSteeringFlee(gkGameObject* obj, gkScalar maxSpeed, const gkVector3& forward, const gkVector3& up, const gkVector3& side, gkGameObject* target, gkScalar minPredictionTime, gkScalar maxPredictionTime)
...
gkSteeringFlee::~gkSteeringFlee()
{
	delete m_sceneObstable;
}

bool gkSteeringFlee::inGoal() const
{
...
bool gkSteeringFlee::steering(STATE& newState, const float elapsedTime)
{
	...
	{
		const Vec3 seek = xxxsteerForFlee(m_target->getPosition());
